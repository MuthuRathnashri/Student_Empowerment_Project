...
const Pricing = () => {
  ...
  const handleButton1Click = () => {
    window.location.href = "https://mat.aima.in/"; // Redirect to GATE website
  };
  ...
  const handleButton3Click = () => {
    window.location.href = "https://www.shiksha.com/mba/articles/best-books-for-mat-exam-preparation-blogId-22089"; // Redirect to e-book reference page
  };
  const handleButton4Click = () => {
    window.location.href = "https://www.youtube.com/watch?v=ucdPVVR9Wjs&list=PL1zxEeUFe9lfDhh_Dewp5xHOnjLatGItQ"; // Redirect to e-book reference page
  };
  const handleButton5Click = () => {
    window.location.href = "https://www.careerindia.com/entrance-exam/mat-question-papers-e40.html"; // Redirect to e-book reference page
  };
