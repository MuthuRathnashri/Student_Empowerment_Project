...
const Pricing = () => {
  ...
  const handleButton1Click = () => {
    window.location.href = "https://satsuite.collegeboard.org/sat"; // Redirect to GATE website
  };
  ...
  const handleButton3Click = () => {
    window.location.href = "https://blog.prepscholar.com/best-sat-prep-books"; // Redirect to e-book reference page
  };
  const handleButton4Click = () => {
    window.location.href = "https://satsuite.collegeboard.org/sat"; // Redirect to e-book reference page
  };
  const handleButton5Click = () => {
    window.location.href = "https://satsuitequestionbank.collegeboard.org/"; // Redirect to e-book reference page
  };
