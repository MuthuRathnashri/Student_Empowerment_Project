...
const Team = () => {
  ...
  const fetchUniversityMentors = async () => {
    try {
      ...
      const universityMentors = response.data.filter(mentor => mentor.expertise === "Stanford University");
  ...
  const handleButton1Click = () => {
    window.location.href = "https://www.stanford.edu/"; // Redirect to Stanford University website
  };

  const handleButton2Click = () => {
    setShowMentors(true); // Show University Mentors
  };

  const handleButton3Click = () => {
    window.location.href = "https://guides.library.stanford.edu/higher_education/recent_ebooks"; // Redirect to e-book reference page
  };
  const handleButton4Click = () => {
    window.location.href = "https://www.youtube.com/stanfordonline"; // Redirect to e-book reference page
  };
  const handleButton5Click = () => {
    window.location.href = "https://www.scribd.com/document/594829262/COLLEGE-ENTRANCE-EXAM-REVIEWER-STANFORD-"; // Redirect to e-book reference page
  };
