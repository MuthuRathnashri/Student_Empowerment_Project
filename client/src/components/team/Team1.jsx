...
const Team = () => {
  ...
  const fetchUniversityMentors = async () => {
    try {
      ...
      const universityMentors = response.data.filter(mentor => mentor.expertise === "Harvard University");
  ...
  const handleButton1Click = () => {
    window.location.href = "https://www.harvard.edu"; // Redirect to Stanford University website
  };
  ...
  const handleButton3Click = () => {
    window.location.href = "https://lit.libguides.com/Write-it-Right/ebooks"; // Redirect to e-book reference page
  };
  const handleButton4Click = () => {
    window.location.href = "https://www.youtube.com/channel/UCKJyv_uNh3LhYFKmwaB63bA"; // Redirect to e-book reference page
  };

  const handleButton5Click = () => {
    window.location.href = "https://people.math.harvard.edu/~knill/exams/1a.pdf"; // Redirect to e-book reference page
  };
