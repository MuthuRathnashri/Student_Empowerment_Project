...
const Team = () => {
  ...
  const fetchUniversityMentors = async () => {
    try {
      ...
      const universityMentors = response.data.filter(mentor => mentor.expertise === "Yale University");
  ...
  const handleButton1Click = () => {
    window.location.href = "https://www.yale.edu"; // Redirect to Stanford University website
  };
  ...
  const handleButton3Click = () => {
    window.location.href = "https://africanscholars.yale.edu/resources/application-resources-test-preparation-materials";
  };
  const handleButton4Click = () => {
    window.location.href = "https://www.youtube.com/user/yalecourses";// Redirect to e-book reference page
  };
  const handleButton5Click = () => {
    window.location.href = "https://physics.yale.edu/academics/graduate-studies/graduate-student-handbook/qualifying-exam-past-exams";// Redirect to e-book reference page
  };
